...
Revision ID: 4f684f2a3014
Revises: 7887ca4c43f2
Create Date: 2021-04-08 22:27:18.580717
...
revision = '4f684f2a3014'
down_revision = '7887ca4c43f2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('lastname', mysql.VARCHAR(length=250), nullable=False),
    sa.Column('name', mysql.VARCHAR(length=250), nullable=False),
